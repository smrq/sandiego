...
#define KEYMAP_KEY_LCTRL  (HID_KEYBOARD_LEFT_CONTROL  | KEYMAP_HARDWARE_KEY)
#define KEYMAP_KEY_LSHIFT (HID_KEYBOARD_LEFT_SHIFT    | KEYMAP_HARDWARE_KEY)
#define KEYMAP_KEY_LALT   (HID_KEYBOARD_LEFT_ALT      | KEYMAP_HARDWARE_KEY)
#define KEYMAP_KEY_LGUI   (HID_KEYBOARD_LEFT_GUI      | KEYMAP_HARDWARE_KEY)
#define KEYMAP_KEY_RCTRL  (HID_KEYBOARD_RIGHT_CONTROL | KEYMAP_HARDWARE_KEY)
#define KEYMAP_KEY_RSHIFT (HID_KEYBOARD_RIGHT_SHIFT   | KEYMAP_HARDWARE_KEY)
#define KEYMAP_KEY_RALT   (HID_KEYBOARD_RIGHT_ALT     | KEYMAP_HARDWARE_KEY)
#define KEYMAP_KEY_RGUI   (HID_KEYBOARD_RIGHT_GUI     | KEYMAP_HARDWARE_KEY)
